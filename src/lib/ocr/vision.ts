...
// ovisnosti. Portano iz Rent-a-Car Manager projekta (packages/api/src/ocr/vision.ts).
...
// dokumente s tablicama polja kao prometna dozvola/osobna iskaznica, prema
// Google dokumentaciji.
