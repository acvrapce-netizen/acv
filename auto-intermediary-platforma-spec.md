...
- **PDV: posebni postupak oporezivanja marže** (čl. 95. st. 2. ZOPDV-a) — primjenjuje se jer je prodavatelj privatna osoba bez prava iskaza PDV-a. PDV se računa samo na maržu (proviziju firme), ne na cijelu cijenu vozila: marža × 0,20 = PDV (faktor za 25% "iznutra").
